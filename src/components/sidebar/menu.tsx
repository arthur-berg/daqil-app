...
export function Menu({ isOpen, setIsOpen }: MenuProps) {
  ...
  const isNonAcceptedProfessionalAgreementPage =
    pathname.includes("professional-agreement") &&
  ...
  return (
    <>
      ...
      <div className="flex flex-col h-full">
        {!isNonAcceptedProfessionalAgreementPage && (
        ...
        <div
          className="w-full px-2 mb-28 sm:mb-10 rtl:mb-28"
          style={
            isNonAcceptedProfessionalAgreementPage ? { marginTop: "4rem" } : {}
          }
        >
          <TooltipProvider disableHoverableContent>
            <Tooltip delayDuration={100}>
